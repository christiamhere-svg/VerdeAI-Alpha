...
const context = {
  ...
  state: {
    analysisComplete: true, version: '8.7', propertyType: 'under-building', preference: 'balanced',
...
if (internal.buildVersion !== 'v8.7' || internal.evidenceKindKey !== 'internal') throw new Error('self-test was not classified as internal');
...
const secondTester = context.normaliseFeedbackItem({
  id: 'tester-two', timestamp: '2026-07-13T00:00:00.000Z', buildVersion: 'v8.7', propertySituation: 'Blank canvas / new build',
...
if (download.filename !== 'verdeai-v8-7-feedback.csv' || !download.content.startsWith('\ufeff')) throw new Error('CSV filename/BOM wrong');
...
console.log('VerdeAI v8.7 feedback evidence unit test passed.');
