...
const context = {
  ...
  state: {
    analysisComplete: true, version: '8.9.2', propertyType: 'under-building', preference: 'balanced',
...
if (internal.buildVersion !== 'v8.9.2' || internal.evidenceKindKey !== 'internal') throw new Error('self-test was not classified as internal');
...
const secondTester = context.normaliseFeedbackItem({
  id: 'tester-two', timestamp: '2026-07-13T00:00:00.000Z', buildVersion: 'v8.9.2', propertySituation: 'Blank canvas / new build',
...
console.log('VerdeAI v8.9.2 feedback evidence unit test passed.');
