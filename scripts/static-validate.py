...
for p in ['index.html','app.js','js/app.js','config.js','package.json','README.md','BUILD_STATUS.md']:
    if '8.8' not in (root/p).read_text(): issues.append(f'8.8 missing in {p}')
