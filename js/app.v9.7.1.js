...
Inspiration: ${inspirationForFuture(selected).title} — separate reference only
...
Honest hybrid result — property map plus separate inspiration, not an exact render.`;
}
