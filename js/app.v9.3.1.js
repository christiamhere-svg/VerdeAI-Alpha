...
const PILOT_SESSION_KEY = "verdeai_v9_3_1_pilot_session";
const PILOT_LOCAL_SAFE_LOCK_KEY = "verdeai_v9_3_1_local_safe_lock";
const pilotRuntime = {
  health: null,
  healthError: "",
  healthCheckedAt: 0,
...
function botanicalDefsSvg(id) {
  return `<defs class="botanical-defs">
    ...
    <g id="${id}-groundcover" class="plant-symbol plant-groundcover" filter="url(#${id}-plant-shadow)">
      <ellipse class="plant-contact-shadow" cx="0" cy="4" rx="58" ry="12"/>
      <g fill="url(#${id}-leaf-soft)">
        <ellipse cx="-43" cy="-10" rx="29" ry="13" transform="rotate(-22 -43 -10)"/>
        <ellipse cx="-25" cy="-27" rx="31" ry="14" transform="rotate(-44 -25 -27)"/>
        <ellipse cx="-5" cy="-17" rx="34" ry="15" transform="rotate(-12 -5 -17)"/>
        <ellipse cx="18" cy="-31" rx="32" ry="14" transform="rotate(35 18 -31)"/>
        <ellipse cx="42" cy="-12" rx="30" ry="13" transform="rotate(20 42 -12)"/>
        <ellipse cx="4" cy="-42" rx="28" ry="12" transform="rotate(4 4 -42)"/>
      </g>
      <g fill="none" stroke="rgba(215,236,194,.48)" stroke-width="3"><path d="M-47-8 Q-22-10 0 2 Q23-10 48-8"/><path d="M-25-25 Q-10-19 0 1 Q12-21 20-29"/></g>
    </g>
    <g id="${id}-shrub" class="plant-symbol plant-shrub" filter="url(#${id}-plant-shadow)">
      <ellipse class="plant-contact-shadow" cx="0" cy="5" rx="64" ry="15"/>
      <g fill="url(#${id}-leaf-deep)">
        <ellipse cx="-45" cy="-27" rx="34" ry="28" transform="rotate(-12 -45 -27)"/>
        <ellipse cx="-26" cy="-57" rx="36" ry="31" transform="rotate(-28 -26 -57)"/>
        <ellipse cx="1" cy="-72" rx="39" ry="34"/>
        <ellipse cx="31" cy="-58" rx="37" ry="31" transform="rotate(24 31 -58)"/>
        <ellipse cx="49" cy="-29" rx="34" ry="28" transform="rotate(12 49 -29)"/>
      </g>
      <g fill="url(#${id}-leaf-soft)" opacity=".94">
        <ellipse cx="-25" cy="-24" rx="38" ry="26" transform="rotate(16 -25 -24)"/>
        <ellipse cx="12" cy="-31" rx="43" ry="29" transform="rotate(-8 12 -31)"/>
        <ellipse cx="32" cy="-15" rx="34" ry="23" transform="rotate(14 32 -15)"/>
      </g>
      <path class="plant-highlight" d="M-49-45 Q-33-64-17-55 M-10-83 Q7-92 22-77 M26-62 Q44-62 54-43"/>
    </g>
    ...
    <g id="${id}-fern" class="plant-symbol plant-fern" filter="url(#${id}-plant-shadow)">
      <ellipse class="plant-contact-shadow" cx="0" cy="4" rx="48" ry="11"/>
      <g fill="none" stroke="url(#${id}-leaf-soft)" stroke-linecap="round">
        <path stroke-width="8" d="M0 0 Q-5-54 -42-92"/><path stroke-width="7" d="M0 0 Q-9-72 -9-116"/><path stroke-width="8" d="M0 0 Q11-67 39-102"/><path stroke-width="7" d="M0 0 Q29-49 58-65"/><path stroke-width="7" d="M0 0 Q-34-38 -62-49"/>
      </g>
      <g fill="none" stroke="rgba(187,217,166,.78)" stroke-width="4" stroke-linecap="round">
        <path d="M-10-28 l-23-7 M-17-42 l-24-4 M-24-57 l-22 1 M-5-39 l18-12 M-6-56 l20-12 M-7-75 l18-14 M16-35 l22-5 M24-52 l22-1 M31-69 l20 4 M-27-25 l-21 4 M36-29 l20 6"/>
      </g>
    </g>
    <g id="${id}-strappy" class="plant-symbol plant-strappy" filter="url(#${id}-plant-shadow)">
      <ellipse class="plant-contact-shadow" cx="0" cy="4" rx="43" ry="11"/>
      <g fill="url(#${id}-leaf-silver)">
        <path d="M-8 0 Q-42-64-47-128 Q-19-87-1 0Z"/><path d="M-2 0 Q-14-96 7-159 Q20-83 10 0Z"/><path d="M7 0 Q25-91 57-133 Q45-60 20 0Z"/><path d="M-1 0 Q-57-39-72-78 Q-32-56 9 0Z"/><path d="M10 0 Q55-40 74-72 Q53-23 20 0Z"/>
      </g>
      <path class="plant-highlight" d="M-33-104 Q-18-62-5-13 M9-139 Q11-72 7-13 M49-112 Q30-60 15-12"/>
    </g>
    <g id="${id}-perennial" class="plant-symbol plant-perennial" filter="url(#${id}-plant-shadow)">
      <ellipse class="plant-contact-shadow" cx="0" cy="4" rx="45" ry="11"/>
      <g fill="none" stroke="url(#${id}-leaf-deep)" stroke-width="6" stroke-linecap="round"><path d="M0 0 Q-22-57-30-104"/><path d="M0 0 Q-4-73 3-128"/><path d="M0 0 Q20-67 31-112"/><path d="M0 0 Q42-46 53-79"/></g>
      <g fill="url(#${id}-leaf-soft)"><ellipse cx="-25" cy="-45" rx="23" ry="10" transform="rotate(30 -25 -45)"/><ellipse cx="17" cy="-53" rx="25" ry="11" transform="rotate(-31 17 -53)"/><ellipse cx="-12" cy="-76" rx="22" ry="9" transform="rotate(23 -12 -76)"/><ellipse cx="31" cy="-83" rx="22" ry="9" transform="rotate(-26 31 -83)"/></g>
      <g class="plant-flowers"><circle cx="-31" cy="-106" r="7"/><circle cx="3" cy="-130" r="8"/><circle cx="31" cy="-114" r="7"/><circle cx="54" cy="-81" r="6"/></g>
    </g>
    <g id="${id}-mound" class="plant-symbol plant-mound" filter="url(#${id}-plant-shadow)">
      <ellipse class="plant-contact-shadow" cx="0" cy="5" rx="61" ry="14"/>
      <path fill="url(#${id}-leaf-deep)" d="M-63 0 Q-58-55-23-72 Q-2-96 25-68 Q58-54 64 0Z"/>
      <g fill="url(#${id}-leaf-soft)" opacity=".92"><ellipse cx="-34" cy="-31" rx="31" ry="18" transform="rotate(-18 -34 -31)"/><ellipse cx="2" cy="-45" rx="35" ry="20"/><ellipse cx="37" cy="-27" rx="31" ry="18" transform="rotate(16 37 -27)"/></g>
      <path class="plant-highlight" d="M-44-37 Q-27-58-10-52 M-5-59 Q12-73 28-56 M24-43 Q42-45 52-29"/>
    </g>
...
function plantPictureOverlayHtml() {
  // Kept as the compatibility hook used by older views; v9.3.1 draws the visual treatment as layered botanical SVG.
...
function specificWhy(future) {
  ...
  const noteLine = note && !note.toLowerCase().startsWith("self-test") ? ` Clue noted: ${note}` : "";
  return `${scenarioFutureFit(future)} ${profile.pattern}: ${constraintLabel(state.constraint)}.${noteLine}`.trim();
}
...
Build v9.3.1 places layered botanical concepts directly on the uploaded photo across six distinct futures. Site interpretation remains clue-guided rule logic. Real AI rendering, backend activation, provider calls, and paid calls are disabled for this Plant Overlay Gate.` : ""}`;
}
  ...
  if (status) {
    ...
    const body = liveReady
      ...
      : pilotRuntime.localSafeLock
        ...
        : pilotRuntime.healthError || "Add the deployed Worker URL to config.v9.3.1.js, configure its required secrets, then check pilot readiness.";
  ...
  setText("ownerActivationLockStatus", ready
    ...
    : pilotRuntime.localSafeLock
      ...
      : configuredApiBaseUrl()
        ...
        : "The five owner decisions are approved, but the deployed Worker URL has not been inserted into config.v9.3.1.js.");
}

function ownerApprovalRequestText() {
  return `VerdeAI Build v9.3.1 — approved pilot settings
...
async function refreshPilotHealth({ force = false, announceResult = false } = {}) {
  ...
  if (!base) {
    pilotRuntime.health = null; pilotRuntime.healthError = "Worker URL not configured. Insert the deployed Worker URL in config.v9.3.1.js."; pilotRuntime.healthCheckedAt = Date.now();
    renderAISetup();
...
function friendlyHealthLockMessage(h = {}) {
  ...
  return "The Worker connected, but one or more approved limits do not match Build v9.3.1.";
}
...
function copyRenderChecklist() {
  const text = `VerdeAI v9.3.1 owner-approved pilot checklist
...
function renderDashboard() {
  ...
  if (today && conceptHost) {
    today.dataset.visualModule = "plant-overlay-gate-v9.3.1";
...
function renderSessionRecovery() {
  ...
  if (!hasWork) {
    el.innerHTML = `<b>Autosave is ready.</b><p>v9.3.1 keeps a local recovery copy while you test, so closing the page should not mean starting from zero.</p>`;
    return;
  }
  const profile = TYPE_PROFILES[state.propertyType] || TYPE_PROFILES["needs-review"];
