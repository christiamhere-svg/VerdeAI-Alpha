...
function enableDemoMode() {
  ...
  state.photoMeta = { compressed: false, demo: true, storedSize: "600×600 bundled demo" };
  ...
  state.calibration = {
    ...
    scenario: "recovery",
    customised: false,
    usable: [point(18, 270), point(982, 235), point(982, 624), point(18, 624)],
    keepClear: [
      { id: "upper-boundary", x: 0, y: 0, width: 1000, height: 210 },
      { id: "stored-materials", x: 770, y: 300, width: 220, height: 330 }
    ],
    access: [point(120, 600), point(600, 360)],
    opportunity: point(510, 390),
    firstMove: point(260, 505)
  };
  calibrationUi.open = false;
  calibrationUi.undo = [];
  setFormFromState();
